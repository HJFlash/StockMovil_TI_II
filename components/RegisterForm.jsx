...
export default function RegisterForm() {
  ...
  const [n_documento, setRut] = useState("");
  const [email, setEmail] = useState("");
  const [password, setPassword] = useState("");
  const [fec_Nacimiento, setNac] = useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    if (!usuario || !nombre || !apellido || !n_documento || !email || !password || !fec_Nacimiento) {
            ...
            <div className="grid grid-cols-2 p-3">
              <div className="NOMBRE">
                <label className="label">
                  ...
                  <input onChange={(e) => setNombre(e.target.value)} type="text" placeholder="Nombre" className="input w-4/5 max-w-xs focus:outline-none rounded-full lnegra p-1 px-5 border-2 border-[#0071E3]" />
                </label>
              </div>
              <div className="APELLIDO">
                ...
                <input onChange={(e) => setApellido(e.target.value)} type="text" placeholder="Apellido" className="input w-4/5 max-w-xs focus:outline-none rounded-full lnegra p-1 px-5 border-2 border-[#0071E3]" />
              </div>
            </div>
            <div className="p-3">
              <div className="p-1">
                ...
                <input onChange={(e) => setUsuario(e.target.value)} type="text" placeholder="Usuario" className="input w-full max-w-xs focus:outline-none rounded-full lnegra p-1 px-5 border-2 border-[#0071E3]" />
              </div>
              <div className="p-1">
                <label className="label">
                  <span className="grid pl-3 justify-items-start label-text">Numero de documento</span>
                </label>
                <input onChange={(e) => setRut(e.target.value)} type="text" placeholder="RUT" className="input w-full max-w-xs focus:outline-none rounded-full lnegra p-1 px-5 border-2 border-[#0071E3]" />                        
              </div>
              <div className="p-1">
                <label className="label">
                  <span className="grid pl-3 justify-items-start label-text">Email</span>
                </label>
                <input onChange={(e) => setEmail(e.target.value)} type="text" placeholder="Correo electronico" className="input w-full max-w-xs focus:outline-none rounded-full lnegra p-1 px-5 border-2 border-[#0071E3]" />                        
              </div>
              <div className="p-1">
              <label className="label">
                <span className="grid pl-3 justify-items-start label-text">Contraseña</span>
              </label>
              <input onChange={(e) => setPassword(e.target.value)} type="text" placeholder="Contraseña" className="input w-full max-w-xs focus:outline-none rounded-full lnegra p-1 px-5 border-2 border-[#0071E3]" />                        
              </div>
            </div>
          </div>
          <div className="">
            <div className="grid grid-cols-2 p-3">
              <div className="">
                ...
                <input onChange={(e) => setNac(e.target.value)} className="p-1 px-5 focus:outline-none rounded-full azul" type="date" /> 
              </div>
              <div>
                <h1>Administrador</h1>
                <input
